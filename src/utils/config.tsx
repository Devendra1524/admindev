export const productFormControls: {
  ...
  export const productTableHeaders: { id: string; label: string }[] = [
    {
      id: "name",
      label: "Name",
    },
  ...
  export const monthsMapper: Record<string, string> = {
    jan: "January",
    feb: "February",
    mar: "March",
    apr: "April",
  ...
  export const deviceMapper: Record<string, string>  = {
    desktop: "Desktop",
    laptop: "Laptop",
    mobile: "Mobile",
    tablet: "Tablet",
  ...
  export const visitorsTableHeaders: { id: string; label: string }[] = [
    {
      id: "visitors",
      label: "Visitors",
    },
